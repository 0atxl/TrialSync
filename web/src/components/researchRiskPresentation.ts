...
export const featureLabels: Record<string, string> = {
  ...
  scheduled_dose_count: 'Expected doses',
  missed_dose_count: 'Missed-dose count',
  missed_dose_rate: 'Missed doses',
  longest_missed_dose_streak: 'Longest missed-dose run',
  delayed_visit_count: 'Delayed visits',
  missed_visit_count: 'Missed-visit count',
  missed_visit_rate: 'Missed visits',
  longest_missed_visit_streak: 'Longest missed-visit run',
