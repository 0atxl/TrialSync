...
export function PatientsPage() {
  ...
  return <section className="route-entry workspace-page">
    <header className="page-heading"><div><p className="eyebrow">Structured records</p><h1>Patients</h1><p>Fictional records with explicit facts, units, dates, and provenance.</p></div><div className="page-actions"><Link className="secondary-button" to="/imports/new?kind=patient">Import text or PDF</Link><Link className="primary-button" to="/patients/new">Add patient</Link></div></header>
